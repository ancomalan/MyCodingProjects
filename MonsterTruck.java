...
public class MonsterTruck extends MotorVehicle {
	...
	public MonsterTruck(int numberOfWins, int numberOfLosses, String specialManuever, int truckYearBuilt, String truckName, String truckBodyType, String truckPowerPlant ) {
		super(truckYearBuilt, truckName, truckBodyType, truckPowerPlant); // initialize inherited data fields from superclass
	...
	//modified toString() method that prints out the details from this subclass and the superclass
	@Override
	public String toString() {
		return "Name: " + getTruckName() + "\nBody type: " + getTruckBodyType() + "\nPower Plant: " + getTruckPowerPlant()
		+ "\nYear: " + getTruckYearBuilt() + "\n# Wins: " + numberOfWins + "\n# Losses: " + numberOfLosses + 
