...
public class MonsterTruckRunner {
	...
	public static void main(String[] args) {
		...
		truck1.calcWinningPercentage(truck1.getNumberOfWins(), truck1.getNumberOfLosses()); //call the win percentage method to display the winning percentage of first truck object 
		System.out.println(); 
		...
		truck2.calcWinningPercentage(truck2.getNumberOfWins(), truck2.getNumberOfLosses()); //call the win percentage method to display winning percentage of second truck object
	}
