...
public class testOCCCDate {
	public static void main (String[] args) {
		...
		System.out.println("The date in US format (mm/dd/yyyy) for the values inputted is: " + OCCCDate.getDayName(theDay) + ", " + theMonth + "/" + theDay + "/" 
				+ theYear);
		...
		System.out.println("The date in US format (mm/dd/yyyy) for the constructor with day, month, and year parameters is: " + 
				OCCCDate.getDayName(myDate.getDayOfMonth()) + ", " + myDate.getMonthNumber() + "/" + myDate.getDayOfMonth() + "/" + myDate.getYear());
		...
		System.out.println("The date in US format for the copy constructor (mm/dd/yyyy) is: " + OCCCDate.getDayName(copyTest.getDayOfMonth()) + ", " 
		...
		System.out.println("The date in US format for the gregorian calendar constructor (mm/dd/yyyy) is: " + OCCCDate.getDayName(gregTest.getDayOfMonth()) 
		...
		System.out.println("The date (today's date) in US format for the default constructor (mm/dd/yyyy) is: " + OCCCDate.getDayName(newDate.getDayOfMonth()) + ", " + 
